<?php
    ...
    if(isset($_SESSION['identificadorUsuario']))
    {
        ...
        $monto = 150.00;
        $concepto = 'Conferencia'; //nombre del paquete
        ...
        $estatus = "No pagado";
        $cred = 0.5;
        if($numpag<150){/**verificará si el número de registros del paquete es menor a 150 */
            /**asignará el folio correspondiente*/
            $idd = str_replace("C","",$numc);/*continuará con la numeración automática del folio*/
            $id = str_pad($numc,8,STR_PAD_LEFT);/**agregará 6 digitos más a la derecha para el folio (número de control) */
            $folio = 'C'.$id;/**guardará el folio en la variable */
            ...
            //$update = "UPDATE alumno SET credito = '$cred' WHERE correo='$nombreUsuarioIngresado'";
    ...
    <main class="contenedor sombra">
        ...
        <!--Creación de tabla datos del alumno-->
         ...
         <div class="contenedor_folio">
            <div id="voucher"> <!--Número de folio del voucher administrador-->
                <p>ID <br><br><?php echo $folio; ?></p>
            </div>
