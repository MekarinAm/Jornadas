    ...
    <body>
        ...
        <div class="TyC5">
            <section class="tallconf">
                ...
                <p>
                    Con este paquete podrá tener el acceso completo a todas las conferencias del 17 al 21, 
                    así como el acceso a tomar uno de los talleres que se impartirán durante la misma semana 
                    y tener el derecho a un crédito y medio
                    complementario en caso de ser
                    requerido
            ...
            <section  class="f1">
                <form action="/php/finPagoCom.php" method="post" class="formulario1" >
                    <div class="TyC4">
                    <section class="tallconf">
                    ...
                    <div class="campo-switch2">
                        <p>Deseo el credito y medio (1.5) complementario:</p>
                        <input type="checkbox" id="switch" value="1.5" name="credito">
